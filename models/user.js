...
/* 
The "models" object is provided by the Mongoose library and stores all the registered
models.If a model names "User" already exists in the "models" object,it assigns that existing
